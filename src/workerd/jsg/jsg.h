...
// Like JSG_TS_ROOT but for use with JSG_STRUCT
...
// Like JSG_STRUCT_TS_OVERRIDE but for use with JSG_STRUCT
...
// Like JSG_STRUCT_TS_DEFINE but for use with JSG_STRUCT
